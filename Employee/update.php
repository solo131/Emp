...
<div class="col-lg-6 m-auto">
	...
	<form method="post">
		<br><div>
            ...
            <input type="text" surname="surname" class="form-control" value="<?php echo $res['surname']; ?>" required><br>
...
if(isset($_POST['done']))
{
$q2="update employee set name = '$name' ,surname = '$surname' , age = $age , salary = $salary , qualification = '$qualification' , date_of_birth = '$date_of_birth' , date_of_join = '$date_of_join' where id = $id";
